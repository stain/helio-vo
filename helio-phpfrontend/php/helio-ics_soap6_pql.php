...
if($itype) {$cl0 = ";($itype)"; } else {$cl0 = ""; }
if ($format == "text") {echo ">>> $cl0 <br> \n";}

//  Observable Entity 1
$oe1x = $_GET['oe1'];
$oe1= "";  $TOR= "";
//if ($oe1x) $oe1="inst_oe1";
...
if($oe1) {$cl1 = ";($oe1)"; } else {$cl1 = ""; }
if ($format == "text") {echo ">>> $cl1 <br> \n";}

//  Observable Entity 2
$oe2x = $_GET['oe2'];
$oe2= "";  $TOR= "";
//if ($oe2x) $oe2="inst_oe2";
...
if($oe2p) {$cl2 = ";($oe2)"; } else {$cl2 = ""; }
if ($format == "text") {echo ">>> $cl2 <br> \n";}

//  Observing Domain 1
$od1x = $_GET['od1'];
$od1= "";  $TOR= "";
//if($od1x) $od1="inst_od1";
...
if($od1) {$cl4 = ";($od1)"; } else {$cl4 = ""; }
if ($format == "text") {echo ">>> $cl4 <br> \n";}

//  Observing Domain 2
$od2x = $_GET['od2'];
$od2= "";  $TOR= "";
//if($od1x) $od2 = "inst_od2";
...
//$psql= "select " . $cols . " from " . $cat . " where '" . $date_from . "'<=time_end and '" . $date_to . "'>=time_start";
  $psql = "FROM="$cat;
  if($date_from) {
   $psql .= "&STARTTIME=" . $date_from;
  }
  if($date_to) {
   $psql .= "&ENDTIME=" . $date_to;
  }
  if($cols) {
   //enable the columns back a little later. KMB
   //$psql .= "&SELECT=" . $cols;
  }
  if ($cat=='instrument') {
     $psql .= "&WHERE=" . $cl0 . $cl1 . $cl2 . $cl4 . $cl5 . $cl3;
  }
...
$root = 'http://msslxw.mssl.ucl.ac.uk:8080/helio-ics/HelioQueryService';

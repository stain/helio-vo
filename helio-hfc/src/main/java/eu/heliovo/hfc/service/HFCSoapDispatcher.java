...
package eu.heliovo.hfc.service;
...
import eu.heliovo.hfc.util.QueryThreadAnalizer;
import eu.heliovo.hfc.util.StandardTypeTable;
...
public class HFCSoapDispatcher implements Provider<Source> {
     private static String jaxbInstance  = "hfc.votable";

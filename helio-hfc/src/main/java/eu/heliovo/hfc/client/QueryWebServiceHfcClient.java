...
public class QueryWebServiceHfcClient { 
	...
	{		
		...
		Element root = doc.createElementNS("http://service.hfc/", "helio:VoTableQueryResponse");			
		//This configuration for TIME.		  	
		Element xqueryElemStartTime = doc.createElementNS("http://service.hfc/","helio:sql");			

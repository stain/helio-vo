...
public class HelioValWindSolarWindTimes {
	...
	public static void main(String[] args) {
		...
		String deldir  = "C:\\Development\\HELIO\\Event_lists\\Tests\\wind_solar_wind_times\\";
		
		String valdir  = "C:\\Development\\HELIO\\Event_lists\\Tests\\wind_solar_wind_times\\";
		// input delivered file name
		String delname = deldir + "WIND_SOLAR_WIND_TIMES.txt";
		
		// input VOTable name
		String valname = valdir + "wind_solar_wind_times_full.xml";

...
public class HelioValWindImfIps {
	...
	public static void main(String[] args) {
		...
		String deldir  = "C:\\Development\\HELIO\\Event_lists\\Tests\\wind_imf_ips\\";
		
		String valdir  = "C:\\Development\\HELIO\\Event_lists\\Tests\\wind_imf_ips\\";
		// input delivered file name
		String delname = deldir + "WIND_IMF_IPS.txt";
		
		// input VOTable name
		String valname = valdir + "wind_imf_ips_full.xml";

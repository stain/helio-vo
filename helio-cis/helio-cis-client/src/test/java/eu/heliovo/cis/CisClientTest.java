...
//	String  			serviceAddress	=	"http://cagnode58.cs.tcd.ie:8080/helio-hps-server/hpsService";
	...
	public CisClientTest() 
	{
		 ...
		 */
		logUtilities.printShortLogEntry("[CIS-CLIENT-TEST] - Creating stubs ...");
	 ...
	 */
	private void initializeCIS() throws Exception
	{
		logUtilities.printShortLogEntry("[CIS-SERVICE-TEST] - Setting up repository ...");
		/*
	...
	private void addUser(String user_name, String user_pwd) throws SecurityUtilitiesException, Exception  
	{
	...
	private boolean isUserPresent(String user_name) throws Exception 
	{

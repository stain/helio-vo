...
public class ConfigurationFactory {
    ...
    private static final String LOG_CONFIGURATION = "log.xml";

    // Factory methods

    public static synchronized Configuration createConfiguration() throws ConfigurationException {
        URL configurationURL = ConfigurationBase.class.getResource(LOG_CONFIGURATION);
        if (configurationURL == null) {
            throw new ConfigurationException("Failed to resolve configuration URL, could not get resource, resource: " + LOG_CONFIGURATION);
        } else {

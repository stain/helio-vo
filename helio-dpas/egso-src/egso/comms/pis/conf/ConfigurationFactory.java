...
public class ConfigurationFactory {
    ...
    private static final String PIS_CONFIGURATION = "pis.xml";

    // Factory methods

    public static synchronized Configuration createConfiguration() throws ConfigurationException {
        URL configurationURL = ConfigurationBase.class.getResource(PIS_CONFIGURATION);
        if (configurationURL == null) {
            throw new ConfigurationException("Failed to resolve configuration URL, could not get resource, resource: " + PIS_CONFIGURATION);
        } else {
    ...
    public static synchronized Configuration createConfiguration(URL configurationURL) throws ConfigurationException {
        ...
        digester.addBeanPropertySetter("configuration/nds/endpoint", "NDSEndpoint");
        digester.addBeanPropertySetter("configuration/nds/updateInterval", "NDSUpdateInterval");

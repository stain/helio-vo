...
public class VSOGetDataRequest  implements java.io.Serializable {
    ...
    private org.virtualsolar.VSO.VSOi.GetDataRequest request;
    ...
    public VSOGetDataRequest(
           ...
           org.virtualsolar.VSO.VSOi.GetDataRequest request) {
     ...
     * @return request
     */
    public org.virtualsolar.VSO.VSOi.GetDataRequest getRequest() {
        return request;
    }
     ...
     * @param request
     */
    public void setRequest(org.virtualsolar.VSO.VSOi.GetDataRequest request) {
        this.request = request;
    }

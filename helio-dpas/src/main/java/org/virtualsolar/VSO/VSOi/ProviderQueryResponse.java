...
public class ProviderQueryResponse  implements java.io.Serializable {
    ...
    private org.virtualsolar.VSO.VSOi.QueryResponseBlock[] record;
    ...
    public ProviderQueryResponse(
           ...
           org.virtualsolar.VSO.VSOi.QueryResponseBlock[] record,
     ...
     * @return record
     */
    public org.virtualsolar.VSO.VSOi.QueryResponseBlock[] getRecord() {
        return record;
    }
     ...
     * @param record
     */
    public void setRecord(org.virtualsolar.VSO.VSOi.QueryResponseBlock[] record) {
        this.record = record;
    }

...
import eu.heliovo.dpas.ie.services.directory.dao.exception.ClassAdUtilitiesException;
...
public class ClassAdUtilities {
	 ...
	 * 
	 * @param expr
	 *            - The ClassAd expression to be returned as a readeable String
	 ...
	 * @throws ClassAdUtilitiesException
	 */
	Expr evaluate(String sel, RecordExpr r) throws ClassAdUtilitiesException {
		/*

...
import eu.heliovo.dpas.ie.services.directory.archives.XRTFileFragment;
...
public class SOT_SPProvider implements DirQueryDao
{
	/*
	 * Path Example:
	 * 
	...
	private void initialize()
	{
		...
		NewPathFragment	timeFragment	=	new XRTFileFragment();

...
public class CirBackwardPropagationModelImpl extends AbstractHelioProcessingServiceImpl<CirProcessingResultObject> implements CirBackwardPropagationModel {
     ...
     */
    public CirBackwardPropagationModelImpl(HelioServiceName serviceName, String serviceVariant) {
    ...
    @Override
    public ProcessingResult<CirProcessingResultObject> execute(Date startTime, String hitObject, Float speed, Float speedError) throws JobExecutionException {

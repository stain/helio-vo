...
public class ConnectionManager {
	 ...
	 * This method returns connection to the data source
	 */
	public static Connection getConnectionLongRunningQuery() { 		
		java.sql.Connection con = null;
		boolean noConnection = true;		
		int i = 0;
		int count=0;
		String jdbcString = "org.hsqldb.jdbcDriver";
	    String jdbcURL = getHsqlDBEmbeddedDatabasePath("jdbc:hsqldb:file:kwpath/HelioDB/testdb")+";hsqldb.default_table_type=cached;shutdown=true";
	    String user = "sa";
	    String passwd = "";
	    System.out.println(" Driver Name : "+jdbcString+" Database URL  : "+jdbcURL+" User : "+user+" Password  "+passwd);
		while(noConnection){

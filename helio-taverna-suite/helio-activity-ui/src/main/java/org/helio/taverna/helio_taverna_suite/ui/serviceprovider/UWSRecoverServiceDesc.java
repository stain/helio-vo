...
public class UWSRecoverServiceDesc extends ServiceDescription<CEAActivityConfigurationBean> {
	...
	public List<String> getPath() {
		...
		return Arrays.asList("Helio", "UWS Run Codes", "Recover");
	}
	...
	protected List<? extends Object> getIdentifyingData() {
		...
		return Arrays.<Object>asList("UWS",ceaIvorn);

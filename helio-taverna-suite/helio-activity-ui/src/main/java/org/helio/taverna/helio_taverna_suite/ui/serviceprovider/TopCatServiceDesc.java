...
import org.helio.taverna.helio_taverna_suite.TopCatActivity;
import org.helio.taverna.helio_taverna_suite.TopCatActivityConfigurationBean;
//import org.helio.taverna.helio_taverna_suite.common.TapQueryHelper;
import net.sf.taverna.raven.appconfig.ApplicationRuntime;

public class TopCatServiceDesc extends ServiceDescription<TopCatActivityConfigurationBean> {
	 ...
	 */
	@Override
	public Class<? extends Activity<TopCatActivityConfigurationBean>> getActivityClass() {
		return TopCatActivity.class;
	}
	 ...
	 */
	@Override
	public TopCatActivityConfigurationBean getActivityConfiguration() {
		TopCatActivityConfigurationBean bean = new TopCatActivityConfigurationBean();
	...
	public List<String> getPath() {
		...
		return Arrays.asList("Helio", "Utils");
	}
	...
	protected List<? extends Object> getIdentifyingData() {
		...
		return Arrays.<Object>asList("helioTopCat");
	}

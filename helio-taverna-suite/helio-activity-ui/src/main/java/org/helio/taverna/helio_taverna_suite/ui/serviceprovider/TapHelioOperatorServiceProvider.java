...
public class TapHelioOperatorServiceProvider implements ServiceDescriptionProvider {
	...
	public void findServiceDescriptionsAsync(
		...
		// of dummy for-loop
		TapHelioOperatorServiceDesc tapHelioService = new TapHelioOperatorServiceDesc();
		tapHelioService.setOperator("AND");
		results.add(tapHelioService);
		
		TapHelioOperatorServiceDesc tapHelioServiceOR = new TapHelioOperatorServiceDesc();
		tapHelioServiceOR.setOperator("OR");
		results.add(tapHelioServiceOR);

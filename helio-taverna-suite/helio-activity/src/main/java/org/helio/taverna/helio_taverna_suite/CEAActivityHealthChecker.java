 ...
 * 
 */
public class CEAActivityHealthChecker implements
		HealthChecker<CEAActivity> {
	...
	public boolean canVisit(Object o) {
		...
		return o instanceof CEAActivity;
	}
	...
	public VisitReport visit(CEAActivity activity, List<Object> ancestry) {
		CEAActivityConfigurationBean config = activity.getConfiguration();
		...
		*/
		...
		// empty
		return new VisitReport(HealthCheck.getInstance(), activity, "CEA service OK", HealthCheck.NO_PROBLEM, subReports);
	}

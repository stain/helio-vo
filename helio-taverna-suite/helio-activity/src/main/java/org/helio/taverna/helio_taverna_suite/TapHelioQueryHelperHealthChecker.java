 ...
 * 
 */
public class TapHelioQueryHelperHealthChecker implements
		HealthChecker<TapHelioQueryHelperActivity> {
	...
	public boolean canVisit(Object o) {
		...
		return o instanceof TapHelioQueryHelperActivity;
	}
	...
	public VisitReport visit(TapHelioQueryHelperActivity activity, List<Object> ancestry) {
		TapHelioQueryHelperActivityConfigurationBean config = activity.getConfiguration();
		...
		*/
		...
		// empty
		return new VisitReport(HealthCheck.getInstance(), activity, "Query Helper service OK", HealthCheck.NO_PROBLEM, subReports);
	}

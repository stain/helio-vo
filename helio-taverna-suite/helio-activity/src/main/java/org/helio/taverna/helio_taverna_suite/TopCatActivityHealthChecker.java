 ...
 * 
 */
public class TopCatActivityHealthChecker implements
		HealthChecker<TopCatActivity> {
	...
	public boolean canVisit(Object o) {
		...
		return o instanceof TopCatActivity;
	}
	...
	public VisitReport visit(TopCatActivity activity, List<Object> ancestry) {
		TopCatActivityConfigurationBean config = activity.getConfiguration();
		...
		*/
		...
		// empty
		return new VisitReport(HealthCheck.getInstance(), activity, "TopCat service OK", HealthCheck.NO_PROBLEM, subReports);
	}

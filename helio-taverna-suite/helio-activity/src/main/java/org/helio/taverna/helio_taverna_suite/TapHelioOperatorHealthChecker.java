 ...
 * 
 */
public class TapHelioOperatorHealthChecker implements
		HealthChecker<TapHelioOperatorActivity> {
	...
	public boolean canVisit(Object o) {
		...
		return o instanceof TapHelioOperatorActivity;
	}
	...
	public VisitReport visit(TapHelioOperatorActivity activity, List<Object> ancestry) {
		TapHelioOperatorActivityConfigurationBean config = activity.getConfiguration();
		...
		*/
		...
		// empty
		return new VisitReport(HealthCheck.getInstance(), activity, "Operator Helper service OK", HealthCheck.NO_PROBLEM, subReports);
	}

 ...
 * 
 */
public class TapHelioActivityHealthChecker implements
		HealthChecker<TapHelioActivity> {
	...
	public boolean canVisit(Object o) {
		...
		return o instanceof TapHelioActivity;
	}
	...
	public VisitReport visit(TapHelioActivity activity, List<Object> ancestry) {
		TapHelioActivityConfigurationBean config = activity.getConfiguration();
		...
		*/
		...
		// empty
		return new VisitReport(HealthCheck.getInstance(), activity, "TAPHelio service OK", HealthCheck.NO_PROBLEM, subReports);
	}

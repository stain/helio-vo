...
public class InstrumentOperationPeriodTO implements Serializable {
	...
	private String insOperationType;
	...
	public String getInsOperationType() {
		return insOperationType;
	}
	public void setInsOperationType(String insOperationType) {
		this.insOperationType = insOperationType;
	}

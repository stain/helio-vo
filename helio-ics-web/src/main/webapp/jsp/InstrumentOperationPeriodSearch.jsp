   ...
   <s:form name="frmInstrumentAdmin" id="frmInstrumentAdmin" method="post" action="">
		...
		<TR>
			<TD align="left" valign="top">
				...
				<TABLE width="100%" border="0" cellspacing="0" cellpadding="0">
					<TR class="txtHeading">
						<TD height="20">
							Instrument Operation Period Search page 
						</TD>
						</TR>
				</TABLE>
			</TD>
    ...
    <tr>
       ...
       <td width="20%" align="left" valign="middle">
	     ...
	     <td width="20%" align="left" valign="middle">&nbsp;
		        <a href="javascript:getInstrumentOperationPeriodDetails();" onMouseOver="MM_swapImage('go','','<%=contextPath%>/Images/but_search_click.gif',1)" onMouseOut="MM_swapImgRestore()" ><img src="<%=contextPath%>/Images/but_search_normal.gif" name="go" border="0" align="absmiddle" id="go"></a>&nbsp;		   		
        </td>
      </tr>
    <!--  <tr>
        <td>&nbsp;</td>
	...
	<table width="100%" border="0" cellspacing="1" cellpadding="0">
		 <tr class="txtPopupGridHeading">
              ...
              <td class="txtblackBP">Instrument Operation Type</td>                    
              <td class="txtblackBP">Instrument Start Date Time</td>
              <td class="txtblackBP">Instrument End Date Time </td>
		  </tr>
		<% int i=0;%>	
		<s:if test='insDetailsOpsPeriodTO!=null'> 
			   <s:iterator value="insDetailsOpsPeriodTO" status="rowstatus" id="insCriTO">
				  ...
				  <tr class='<s:property value="#classType"/>' height="10" align="left" valign="middle">
				    <td>
					   <IMG src="<%=contextPath%>/Images/icon_edit.gif" style="CURSOR:hand" onclick="javascript:editInstrumentOperationPeriodtPage('<s:property value="#insCriTO.getId()"/>')"/>
					</td>
					<td>
					...
					<td>
						<s:property value="#insCriTO.getInsOperationType()" />
					</td>
					<td>

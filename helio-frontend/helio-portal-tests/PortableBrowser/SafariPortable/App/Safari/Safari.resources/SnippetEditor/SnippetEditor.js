...
var SnippetEditor = {
    ...
    loaded: function()
    {
        ...
        entryElement.addEventListener("paste", this.entryClipboardEvent.bind(this), false);
        entryElement.addEventListener("cut", this.entryClipboardEvent.bind(this), false);
    ...
    entryClipboardEvent: function(event)
    {
        if (SnippetEditorController.autoUpdate)
            this.updatePreviewSoon();
    },

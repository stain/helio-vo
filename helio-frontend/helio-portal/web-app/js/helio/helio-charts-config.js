		...
		**/
		xFunction: function (actualValue) {
			...
			if((actualValue != '-') && (actualValue != null) && actualValue != undefined) {
				...
				} else if(actualLetter == 'X'){ // The letter is 'X'
					// Check the number and return the correct category
					if(actualNumber < 2){
						return 'X1 - X1.9';
					} else if(actualNumber < 3){
				...
				} else { // The letter is neither 'C' nor 'M' nor 'X'
					return '-';
				}
...
/**
* Configuration object for the catalogue 'rhessi_hxr_flare'
*/
var object_rhessi_hxr_flare = {
    ...
    histogram: {
        ...
        yAxisName: 'The number of flares which where observed<br />within this highest energy band.',
        /**
        * This function gets a value and returns the correct category (out of
        * the array xAxisCategories).
        *
        ...
        xFunction: function (actualValue) {
            ...
            if((actualValue != '-') && (actualValue != null) && actualValue != undefined) {
				...
				if(actualValue == 3){
					...
					return '100';
				} else if(actualValue == 300){
					return '300';
				} else if(actualValue == 800){
					return '800';
				} else if(actualValue == 7000){
					return '7000';
				} else {
					return '-';
				}

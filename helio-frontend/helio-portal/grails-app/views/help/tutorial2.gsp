...
<head>
<meta charset="UTF-8">
<title>Tutorial 2: Use the data cart</title>
</head>
<body>
	<h2>
		<a name="_Toc204246078">Tutorial 2: Use the data cart</a>
	</h2>

	<p>The main purpose of the data cart is to connect multiple tasks
		together. In this tutorial we explain how data can be added to the
		data cart, how it can be managed and finally how it is connected it to
		other services. The screenshots in this tutorial base on the results
		of the previous tutorial.</p>

	<h3>
		<a name="_Toc204246079">Adding data to the data cart</a>
	</h3>
	...
	<ol start="2" type="1">
		<li>Inspect a row of your result table. Click on the magnifying
			...
			cart.</li>
		<li>The third option is to select on or several rows in a result
			table and click on the extract icon (<img height="16"
			src="hfe_tutorial_v0.1-7-13_2.png" />). This will popup the data
			extraction dialog. Clicking ok will add the selected dates to the
			data cart.
		</li>
	</ol>
	<p>
		<img height="16" src="hfe_tutorial_v0.1-7-13_3.png"><br />
		Figure 13: Data extraction dialog. The input box at the bottom allows
		specifying a name for the data cart item.
	</p>
	...
	<p>
		<img width="150" src="hfe_tutorial_v0.1-7-14_1.png"><br />
		Figure 14: Two sample items in the data cart, once with the default
		label ("eventlist") and once with a custom label
	</p>
	...
	<ol start="6" type="1">
		...
		<li>Drop the previously stored time range to the grey circle.
			Clicking on the yellow circle, the select button or the box will

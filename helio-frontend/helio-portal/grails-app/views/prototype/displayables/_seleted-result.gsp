  ...
  <table style="clear:both;width:850px;margin-top:30px;margin-bottom: 30px">
    <tr>
      <td class="row-borders" id="time-row">
        <img style="margin-left:100px;height:40px;padding-bottom:20px " src="${resource(dir:'images/icons/toolbar',file:'hex_time.png')}" />
       <center> <h2>Time Selection</h2></center>
      </td>
      <td class="row-borders" id="instrument-row">
        <img style="margin-left:100px;height:40px;padding-bottom:20px" src="${resource(dir:'images/icons/toolbar',file:'hex_in.png')}" />
        <center><h2>Instrument Selection</h2></center>
      </td>
      <td class="row-borders" id="observatory-row" style="border-right:1px solid black">
        <img style="margin-left:100px;height:40px;padding-bottom:20px" src="${resource(dir:'images/icons/toolbar',file:'hex_tab.png')}" />

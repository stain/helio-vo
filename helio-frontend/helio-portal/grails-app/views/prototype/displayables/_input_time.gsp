  ...
  <tr>
    ...
    <td>
      <table  width="500px" cellpadding="0" cellspacing="0">
        ...
        <tr id="input_time_range_1">
          <td align="center" valign="center">
            Range 1
          </td>
          <td align="center" valign="center">
            <input size="12" type="text" id="minDate" name="minDate" value="2003-01-01"/>
            <input size="6" type="text" name="minTime" id="minTime" value="00:00" />
          </td>
          <td align="center" valign="center">
            <input size="12" type="text" id="maxDate" name="maxDate" value="2003-01-03"/>


            <input size="6" type="text" name="maxTime" id="maxTime" value="00:00" />
          </td>
        </tr>

 ...
 * generated in the eu.heliovo.workflow.clients.ics package. 
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: eu.heliovo.workflow.clients.ics
     * 
     */

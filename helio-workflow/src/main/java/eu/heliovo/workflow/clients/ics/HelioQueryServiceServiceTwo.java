 ...
 * 
 */
@WebServiceClient(name = "HelioQueryServiceServiceTwo", targetNamespace = "http://helio-vo.eu/xml/QueryService/v0.1", wsdlLocation = "http://msslxw.mssl.ucl.ac.uk:8080/helio-ics/HelioTavernaService?wsdl")
public class HelioQueryServiceServiceTwo
    extends Service
{

    private final static URL HELIOQUERYSERVICESERVICETWO_WSDL_LOCATION;
    private final static Logger logger = Logger.getLogger(eu.heliovo.workflow.clients.ics.HelioQueryServiceServiceTwo.class.getName());

    static {
        URL url = null;
        try {
            URL baseUrl;
            baseUrl = eu.heliovo.workflow.clients.ics.HelioQueryServiceServiceTwo.class.getResource(".");
            url = new URL(baseUrl, "http://msslxw.mssl.ucl.ac.uk:8080/helio-ics/HelioTavernaService?wsdl");
        } catch (MalformedURLException e) {
            logger.warning("Failed to create URL for the wsdl Location: 'http://msslxw.mssl.ucl.ac.uk:8080/helio-ics/HelioTavernaService?wsdl', retrying as a local file");

	     ...
	     <TABLE width="100%" border="0" cellspacing="1" cellpadding="0" >
  		 ...
  		 <table width="100%" border="0" cellspacing="0" cellpadding="0">
		    <tr align="left" valign="middle">
				<td align="left">&nbsp;
					<a  onclick="javascript: doneDatabaseConnection()" style="cursor:hand" onMouseOver="MM_swapImage('addcol','','<%=contextPath%>/Images/but_done_click.gif',1)" onMouseOut="MM_swapImgRestore()"><img src="<%=contextPath%>/Images/but_done_normal.gif" name="Close"  border="0" align="absmiddle" id="addcol"></a>
				</td>
	        </tr>
	     </table>
	  	<table width="100%">

...
;
; PURPOSE:
; 		This routine initializes SDOSS code meta-data for the 
...
;
; CALLING SEQUENCE:
;		sdoss_hfc_setup, oby_stc, frc_stc, obs_stc, pp_info_stc, pp_out_stc, feat_stc
;
; INPUTS:
;		None.
;	
...
;
; OUTPUTS:
;		oby_stc       - Structure containing information about observatory.
...
PRO sdoss_hfc_setup, oby_stc, frc_stc, obs_stc, pp_info_stc, pp_out_stc, feat_stc

;Observatory information
oby_stc = {hfc_observatory}
oby_stc = replicate(oby_stc,2)
oby_stc.id_observatory = [1,2]
oby_stc.observat=['SDO','SDO']
oby_stc.instrume=['HMI','HMI']
oby_stc.telescop=['continuum','magnetogram']
oby_stc.units=['counts','gauss']
oby_stc.wavemin=['617.133','617.133']
oby_stc.wavemax=['617.133','617.133']
oby_stc.waveunit=['nm','nm']
oby_stc.wavename=['Fe I','Fe I']
oby_stc.spectral_name=['visible','line_of_sight magnetic field']
oby_stc.obs_type=['Remote-sensing','Remote-sensing']
oby_stc.comment=['Ic_45s','M_45s']

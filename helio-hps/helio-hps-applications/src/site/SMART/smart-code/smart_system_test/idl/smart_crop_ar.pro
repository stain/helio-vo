...
function smart_crop_ar, imgin, maskin, id, arstruct=arstruct, zerother=zerother, standard=standard, $
	boxdim=bdim, boxxyc=boxxyc, plot=plot, mmplot=mmplot, asecplot=asecplot, $
	contourplot=contourplot, limbplot=limbplot, psplot=psplot, outfile=outfile, minplot=minplot,maxplot=maxplot,_extra=_extra

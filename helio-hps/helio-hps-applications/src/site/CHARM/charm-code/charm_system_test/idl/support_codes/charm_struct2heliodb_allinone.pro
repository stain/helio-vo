...
;------------------------------------------------------------------------------------------
  group.chgr_br_hgdeg_long0=grpstr.chgr_br_HG_LONLAT_DEG_DISK[0,0]  &   group.chgr_br_hgdeg_lat0=grpstr.chgr_br_HG_LONLAT_DEG_DISK[1,0]
  group.chgr_br_hgdeg_long1=grpstr.chgr_br_HG_LONLAT_DEG_DISK[0,1]  &   group.chgr_br_hgdeg_lat1=grpstr.chgr_br_HG_LONLAT_DEG_DISK[1,1]
  group.chgr_br_hgdeg_long2=grpstr.chgr_br_HG_LONLAT_DEG_DISK[0,2]  &   group.chgr_br_hgdeg_lat2=grpstr.chgr_br_HG_LONLAT_DEG_DISK[1,2]
  group.chgr_br_hgdeg_long3=grpstr.chgr_br_HG_LONLAT_DEG_DISK[0,3]  &   group.chgr_br_hgdeg_lat3=grpstr.chgr_br_HG_LONLAT_DEG_DISK[1,3]
;------------------------------------------------------------------------------------------
...
;------------------------------------------------------------------------------------------
  group.chgr_cbr_hgdeg_long=grpstr.chgr_cbr_deg[0]  &  group.chgr_cbr_hgdeg_lat=grpstr.chgr_cbr_deg[1]
;------------------------------------------------------------------------------------------
...
;------------------------------------------------------------------------------------------
  ch.ch_br_hgdeg_long0=chstr.ch_br_HG_LONLAT_deg_disk[0,0]  &   ch.ch_br_hgdeg_lat0=chstr.ch_br_HG_LONLAT_deg_disk[1,0]
  ch.ch_br_hgdeg_long1=chstr.ch_br_HG_LONLAT_deg_disk[0,1]  &   ch.ch_br_hgdeg_lat1=chstr.ch_br_HG_LONLAT_deg_disk[1,1]
  ch.ch_br_hgdeg_long2=chstr.ch_br_HG_LONLAT_deg_disk[0,2]  &   ch.ch_br_hgdeg_lat2=chstr.ch_br_HG_LONLAT_deg_disk[1,2]
  ch.ch_br_hgdeg_long3=chstr.ch_br_HG_LONLAT_deg_disk[0,3]  &   ch.ch_br_hgdeg_lat3=chstr.ch_br_HG_LONLAT_deg_disk[1,3]
;------------------------------------------------------------------------------------------
...
;------------------------------------------------------------------------------------------
  ch.chc_hgdeg_long=chstr.chc_latlon_deg_disk[0]   &   ch.chc_hgdeg_lat=chstr.chc_latlon_deg_disk[1]
;------------------------------------------------------------------------------------------
...
spawn,'echo "# GroupID	; HGLon,Lat ; E/W-most points [Deg] ;  Area [10^7Mm2]; Bz [G] ; Phi[10^23Mx] " > ' + outfile
...
;                spawn,'echo "<tr class=chresults align=center><td>'+string(thisgr.chgr_num,format='(I2)')+'</td><td>'+string(thisgr.chgr_cbr_DEG[0],form='(F5.1)')+','+string(thisgr.chgr_cbr_DEG[1],form='(F5.1)')+'</td><td>'+string(thisgr.chgr_br_deg[0])+'/'+string(thisgr.chgr_br_deg[2])+'</td><td>'+string(thisgr.chgr_area_mm/1e7,format='(F7.2)')+'</td><td>'+string(thisgr.chgr_mean_bz,form='(F7.2)')+'</td><td>'+string(thisgr.chgr_mean_bz*thisgr.chgr_area_mm/1e7,form='(F7.2)')+'</td></tr>" >> '+outfile
                ...
                spawn, 'echo " '+string(thisgr.chgr_num,format='(I2)')+';'+heliocentric_coords+ $
                               ';'+EWlimits+';'+string(thisgr.chgr_area_mm/1e7,format='(F7.2)')+ $
                               ';'+string(thisgr.chgr_mean_bz,form='(F7.2)')+';' +string(thisgr.chgr_mean_bz*thisgr.chgr_area_mm/1e7,form='(F7.2)')+ $
                               '" >> '+ outfile
	endfor
 ;writing footer
...
;; EIT FILE NUMBERING AND OUTPUT
  obs_table,inst='eit',fits_file=s_f.eit_filename,orig_file=s_f.eit_filename,file_num=eit_num,file_obs=eit_file_obs,infile_search=eit_insearch,check_num=eit_check_num,save_path=eit_save_path,pathinstr=eitpath
